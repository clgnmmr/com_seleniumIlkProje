 ...
 */
      ...
      //   2- Basligin Amazon kelimesi icerdigini test edin
        ...
        }else System.out.println("Title "+arananKelime+"'yi icermiyor, title testi FAİLED");
       // 3- Url'in "https://www.amazon.com" a esit oldugunu test edin
        String actualUrl=driver.getCurrentUrl();
        String expectedUrl="https://www.amazon.com/";
        if (actualUrl.equals(expectedUrl)){
            System.out.println("Url testi PASSED");
        }else System.out.println("actual url :"+driver.getCurrentUrl()+"  beklenen URL'den farkli,");
       // 4- sayfayi kapatin
        driver.close();
    }
}
